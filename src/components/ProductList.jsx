...
function ProductList() {
  ...
  useEffect(() => {
    const getProducts = async () => {
      ...
      dispatch(setProducts(res.data)); // es una lista de cervezas para un e-comerce - https://unicornbeer.vercel.app/ (front) - https://unicornbeer-api.vercel.app/products (back)
    };
    getProducts();
  }, []);
